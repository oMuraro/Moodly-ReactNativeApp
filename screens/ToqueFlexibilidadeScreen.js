...
export default function ToqueFlexibilidadeScreen({ navigation }) {
  ...
  const fases = ['Prepare-se', 'Toque nos pés', 'Flexão lateral', 'Torção'];
  const instrucoes = [
    'Prepare-se para o exercício de flexibilidade',
    'Sentado, tente tocar os pés',
    'Incline o corpo para o lado',
    'Faça uma leve torção do tronco'
  ];
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.title}>Toque de Flexibilidade</Text>
        ...
        <View style={styles.circleContainer}>
          ...
          <View style={[styles.circle, styles.circle2, { 
            ...
            <Icon name="move" size={30} color="#fff" />
          </View>
          <View style={styles.line} />
          <View style={[styles.circle, styles.circle3, { 
            ...
            <Icon name="rotate-cw" size={30} color="#fff" />
          </View>
        </View>
